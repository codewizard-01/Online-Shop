...
<html lang="en">
  ...
  <body>
    <!-------------- Section - Header SVGs ------------>
    <svg xmlns="http://www.w3.org/2000/svg" class="d-none header-icons">
      ...
      <div class="px-3 py-2 text-bg-dark border-bottom">
        <div class="container">
          ...
          >
            ...
            >
              <li>
                <a href="#" class="nav-link text-secondary active">
                  <svg
                    class="bi d-block mx-auto mb-1 active"
                    width="24"
                    height="24"
                  >
                    <use xlink:href="#home" />
      ...
      <div id="demo" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              src="assets/images/hero-carousel/2024-27.jpg"
              alt="online shoping images"
              class="d-block"
          ...
          <div class="carousel-item">
            <img
              src="assets/images/hero-carousel/2024-28.jpg"
              alt="online shoping images"
              class="d-block"
              style="width: 100%; height: 75vh"
            />
          ...
          <div class="carousel-item">
            <img
              src="assets/images/hero-carousel/2024-26.jpg"
              alt="online shoping images"
              class="d-block"
              style="width: 100%; height: 75vh"
            />
